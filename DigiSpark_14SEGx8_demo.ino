...
//2019.08.25 Hideshi Maeno
#include <tinySPI.h>
// tinySPI by JChristensen  https://github.com/JChristensen/tinySPI/
#define HARDWARE_SPI 1    // tintSPI: set to 1 to use hardware SPI, set to 0 to use shiftOut (software SPI)

// tinySPI pin definitions
const int
    LATCH_PIN(0),               // storage register clock (slave select)
    DATA_PIN(1),                // data in
    CLOCK_PIN(2);               // shift register clock

#define N_DISP 1 // number of 8-digit 14SEG display unit
#define N_MSG 1
...
//  SPI.setBitOrder(MSBFIRST); // TinySPI doesn't support this line
//  SPI.setClockDivider(SPI_CLOCK_DIV4); // TinySPI doesn't support this line
